...
"filter",p.filterGenerator);_.setMethod(iterator,"map",p.mapGenerator);_.setMethod(iterator,"unique",p.uniqueGenerator);_.setMethod(iterator,"iterate",iterateGenerator);_.setMethod(iterator,"enumerate",EnumerateGenerator);_.setMethod(iterator,"then",p.then);_.setMethod(iterator,"toArray",p.toArray);_.setMethod(iterator,"stringify",p.stringify);_.setMethod(iterator,"flatten",p.flattenGenerator);_.setMethod(iterator,"reduce",p.reduce);_.setMethod(iterator,"each",p.each);_.setMethod(iterator,"every",
...
"toArray",p.toArray);_.setMethod(CounterGenerator.prototype,"then",p.then);_.setMethod(CounterGenerator.prototype,"reduce",p.reduce);_.setMethod(CounterGenerator.prototype,"every",p.every);_.setMethod(CounterGenerator.prototype,"each",p.each);function getYieldValue(opts,object,key){var result,value;if(opts.keys)result=key;else{value=object[key];if(opts.values)result=value;else result=[key,value]}return result}function*arrayGenerator(subject,opts){var generator=new CounterGenerator,key;setReverseGenerator(opts,
generator.to(_.lastIndex(subject)));for(key of generator)yield getYieldValue(opts,subject,key)}function ArrayGenerator(subject){if(!(this instanceof ArrayGenerator))return new ArrayGenerator(subject);var opts={reversed:false,entries:true,values:false,keys:false};_.setMethod(this,"state",function(){return{reversed:opts.reversed,entries:opts.entries,values:opts.values,keys:opts.keys}});_.setMethod(this,Symbol.iterator,function(){return arrayGenerator(subject,this.state())});_.setMethod(this,"entries",
function(){opts.entries=true;opts.values=false;opts.keys=false;return this});_.setMethod(this,"values",function(){opts.entries=false;opts.values=true;opts.keys=false;return this});_.setMethod(this,"keys",function(){opts.entries=false;opts.values=false;opts.keys=true;return this});_.setMethod(this,"reverse",function(){opts.reversed=!opts.reversed;return this})}_.setMethod(ArrayGenerator.prototype,"map",p.mapGenerator);_.setMethod(ArrayGenerator.prototype,"filter",p.filterGenerator);_.setMethod(ArrayGenerator.prototype,
"toArray",p.toArray);_.setMethod(ArrayGenerator.prototype,"then",p.then);_.setMethod(ArrayGenerator.prototype,"unique",p.uniqueGenerator);_.setMethod(ArrayGenerator.prototype,"flatten",p.flattenGenerator);_.setMethod(ArrayGenerator.prototype,"reduce",p.reduce);_.setMethod(ArrayGenerator.prototype,"each",p.each);_.setMethod(ArrayGenerator.prototype,"every",p.every);function getStringYieldValue(opts,character,key){var value,result;if(opts.keys)result=key;else{value=String.fromCodePoint(character.codePointAt(0));
if(opts.values)result=value;else result=[key,value]}return result}function*stringGenerator(subject,opts){var generator=new CounterGenerator(opts),next=true,char1,char2,key;setReverseGenerator(opts,generator.to(_.lastIndex(subject)));for(key of generator)if(next)if(opts.reversed){char1=subject[key-1];char2=subject[key];next=!_.isSurrogatePair(char1,char2);if(next)yield getStringYieldValue(opts,char2,key)}else{char1=subject[key];char2=subject[key+1];next=!_.isSurrogatePair(char1,char2);yield getStringYieldValue(opts,
char1+char2,key)}else{next=!next;if(opts.reversed)yield getStringYieldValue(opts,char1+char2,key)}}function StringGenerator(subject){if(!(this instanceof StringGenerator))return new StringGenerator(subject);var opts={reversed:false,entries:true,values:false,keys:false};_.setMethod(this,"state",function(){return{reversed:opts.reversed,entries:opts.entries,values:opts.values,keys:opts.keys}});_.setMethod(this,Symbol.iterator,function(){return stringGenerator(subject,this.state())});_.setMethod(this,
"entries",function(){opts.entries=true;opts.values=false;opts.keys=false;return this});_.setMethod(this,"values",function(){opts.entries=false;opts.values=true;opts.keys=false;return this});_.setMethod(this,"keys",function(){opts.entries=false;opts.values=false;opts.keys=true;return this});_.setMethod(this,"reverse",function(){opts.reversed=!opts.reversed;return this})}_.setMethod(StringGenerator.prototype,"map",p.mapGenerator);_.setMethod(StringGenerator.prototype,"filter",p.filterGenerator);_.setMethod(StringGenerator.prototype,
"toArray",p.toArray);_.setMethod(StringGenerator.prototype,"then",p.then);_.setMethod(StringGenerator.prototype,"unique",p.uniqueGenerator);_.setMethod(StringGenerator.prototype,"stringify",p.stringify);_.setMethod(StringGenerator.prototype,"reduce",p.reduce);_.setMethod(StringGenerator.prototype,"each",p.each);_.setMethod(StringGenerator.prototype,"every",p.every);function*enumerateGenerator(subject,opts){for(var key in subject)if(!opts.own||_.hasOwn(subject,key))yield getYieldValue(opts,subject,
